...
# --- Step 1: Decompress shape predictor file if needed ---
...
# --- Step 2: Load Dlib's face detector and landmark predictor ---
detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor(decompressed_file)

# --- Step 3: Initialize ORB keypoint detector ---
orb = cv2.ORB_create()
...
def detect_tongue_surface(frame):
    ...
    for face in faces:
        ...
        # Optional: Check if mouth is open (landmarks 62 & 66)
        top_lip = shape[62]
        bottom_lip = shape[66]
        ...
        # --- Step 4: Color-based segmentation for tongue surface detection ---
        ...
        # --- Step 5: Edge detection for texture (surface of the tongue) ---
        ...
        # --- Step 6: Find the contour of the detected tongue surface ---
